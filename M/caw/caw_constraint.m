function [c,ceq] = caw_constraint(parameters,data,dataAsym,p,o,q,backCast,backCastAsym,type,lambda_diag,lambda_offdiag,lambda_matrices) %#ok<*INUSL>
...
ceq = [];
k = size(data,2);
[~,A,G,B,~] = caw_parameter_transform(parameters,p,o,q,k,type);
